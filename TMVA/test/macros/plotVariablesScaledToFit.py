...
if not os.path.exists('FullTestScaled'):
    command = 'mkdir FullTestScaled/'
    os.system(command)
for r in regions:
    if not os.path.exists('FullTestScaled/'+r):
        command = 'mkdir FullTestScaled/'+r
        os.system(command)
...
#            print plot, mode, reg
            ...
            hists[0].Scale(fitSF[mode+reg][0])
            hists[1].Scale(fitSF[mode+reg][0])
            hists[2].Scale(fitSF[mode+reg][2])
            hists[4].Scale(fitSF[mode+reg][2])
...
#             labelcms.AddText(ksLabel)
            ...
            c1.SaveAs("FullTestScaled/"+reg+"/"+plot+"_"+reg+"_"+mode+".pdf")
            c1.SaveAs("FullTestScaled/"+reg+"/"+plot+"_"+reg+"_"+mode+".png")
...
#         labelcms.AddText(ksLabel)
        ...
        c1.SaveAs("FullTestScaled/"+reg+"/"+plot+"_"+reg+".pdf")
        c1.SaveAs("FullTestScaled/"+reg+"/"+plot+"_"+reg+".png")
