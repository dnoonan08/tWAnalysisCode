...
#            for event in tree:
                ...
                if 'TTbar' in file:
                    ...
                    HistoLists[chan][reg][fileHistoInput[fileNum]][1][-2][0].Fill(_BDT, _weight*(1.+_topPTSF))
                    HistoLists[chan][reg][fileHistoInput[fileNum]][1][-2][1].Fill(_BDT, _weight*(1.-_topPTSF))
                    ...
                    HistoLists[chan][reg][fileHistoInput[fileNum]][1][-1][0].Fill(_BDT, _weight*(1.+spinSF))
                    HistoLists[chan][reg][fileHistoInput[fileNum]][1][-1][1].Fill(_BDT, _weight*(1.-spinSF))
...
outFile = TFile('inputFiles/inputFileTheta_'+BDT+ExtraNames+'_WithData.root','RECREATE')
