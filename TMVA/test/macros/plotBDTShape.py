...
BDT_Train = [TH1F('BDTTrainSig','',35,-0.4,0.3), TH1F('BDTTrainBkg','',35,-0.4,0.3)]
BDT_Test  = [TH1F('BDTTestSig','',35,-0.4,0.3),  TH1F('BDTTestBkg','',35,-0.4,0.3)]
...
Traintree.Add('../trainrootfiles/test_tw_00_NewTestsJune25.root')
Testtree.Add('../trainrootfiles/test_tw_00_NewTestsJune25.root')



for event in Traintree:
    classID = event.classID
    BDT = event.AdaBoostDefault_NewTests
...
leg.SetBorderSize(1)
leg.AddEntry(BDT_Train[0], "Signal: tW", "f")
leg.AddEntry(BDT_Train[1], "Background: t#bar{t}", "f")
...
BDT_Train[0].GetXaxis().SetTitle('BDT Discriminant')
...
c1.Update()
c1.SaveAs("BDTshape_overtraining.pdf")
