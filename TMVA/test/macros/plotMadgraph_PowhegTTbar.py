...
specialName = 'TTbarMadgraphPowheg'
...
leg.AddEntry(HistoLists[0][0]['ptjet'], "t#bar{t} Madgraph", "l")
leg.AddEntry(HistoLists[0][1]['ptjet'], "t#bar{t} Powheg", "l")
...
for mode in range(4):
    ...
    for plot in plotInfo:
        ...
        h_ratio.GetYaxis().SetTitle("#frac{Madgraph}{Powheg}")
