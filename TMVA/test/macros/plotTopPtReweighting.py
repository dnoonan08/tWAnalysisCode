...
specialName = 'TTbarTopPtReweighting'
...
for mode in range(3):
    ...
    for i in range(len(fileList)):
        ...
        tree.Add('../tmvaFiles/'+vFolder+'/'+file)
...
for h in HistoLists:
    for f in h:
        f['BDTRebinned'].SetBinContent(1,f['BDT-Binned'].GetBinContent(1))
        f['BDTRebinned'].SetBinContent(2,f['BDT-Binned'].GetBinContent(2))
        f['BDTRebinned'].SetBinContent(3,f['BDT-Binned'].GetBinContent(3))
        f['BDTRebinned'].SetBinContent(4,f['BDT-Binned'].GetBinContent(4))
        f['BDTRebinned'].SetBinContent(5,f['BDT-Binned'].GetBinContent(5))

        f['BDTRebinned'].SetBinError(1,f['BDT-Binned'].GetBinError(1))
        f['BDTRebinned'].SetBinError(2,f['BDT-Binned'].GetBinError(2))
        f['BDTRebinned'].SetBinError(3,f['BDT-Binned'].GetBinError(3))
        f['BDTRebinned'].SetBinError(4,f['BDT-Binned'].GetBinError(4))
        f['BDTRebinned'].SetBinError(5,f['BDT-Binned'].GetBinError(5))
...
leg.AddEntry(HistoLists[0][1]['ptjet'], "t#bar{t} Top Pt", "l")
...
for mode in range(4):
    ...
    for plot in plotInfo:
        ...
        h_ratio.GetYaxis().SetTitle("#frac{TTbar}{TTbarTopPt}")
