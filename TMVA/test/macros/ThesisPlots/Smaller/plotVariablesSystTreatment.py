...
file = TFile('../../../HistogramFile/variablePlots_RunD.root','r')
...
#             oneLine.Draw("e same")
            ...
            c1.SaveAs("plots2/"+reg+"/"+plot+"_"+reg+"_"+mode+".pdf")
            c1.SaveAs("plots2/"+reg+"/"+plot+"_"+reg+"_"+mode+".png")
...
#         dataRatio.GetXaxis().SetTitleOffset(.83)
        ...
        c1.SaveAs("plots2/"+reg+"/"+plot+"_"+reg+".pdf")
        c1.SaveAs("plots2/"+reg+"/"+plot+"_"+reg+".png")
