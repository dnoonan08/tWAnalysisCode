...
#file = TFile('HistogramFile/test.root','r')
file = TFile('HistogramFile/testAdaBoostBDT.root','r')
...
errorFile = TFile('errorBands/AdaBoost.root', 'RECREATE')

if 'testAdaBoost' in file.GetName():
    BDT = 'AdaBoost'
...
labelcms = TPaveText(0.14,0.68,0.6,0.92,"NDCBR")
...
#             labelcms.AddText(ksLabel)
            ...
            c1.SaveAs("FullTest/"+BDT+"/"+reg+"/"+plot+"_"+reg+"_"+mode+".pdf")
            c1.SaveAs("FullTest/"+BDT+"/"+reg+"/"+plot+"_"+reg+"_"+mode+".png")
...
#         labelcms.AddText(ksLabel)
        ...
        c1.SaveAs("FullTest/"+BDT+"/"+reg+"/"+plot+"_"+reg+".pdf")
        c1.SaveAs("FullTest/"+BDT+"/"+reg+"/"+plot+"_"+reg+".png")
