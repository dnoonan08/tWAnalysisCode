...
/* \Class SingleTopMCProducer_tW
 *
 * \Authors: A. Giammanco, A. Orso M. Iorio
 * 
 * \ version $Id: SingleTopMCProducer_tW.h,v 1.1.2.1 2012/11/26 10:26:00 oiorio Exp $
 */
...
//class JetFlavourIdentifier;
  ...
  class SingleTopMCProducer_tW : public edm::EDProducer {

    public:

      explicit SingleTopMCProducer_tW(const edm::ParameterSet & iConfig);
      ~SingleTopMCProducer_tW();
