...
process.source = cms.Source ("PoolSource",
                             ...
                             'file:/mnt/hadoop/user/uscms01/pnfs/unl.edu/data4/cms/store/user/dnoonan/tW_8TeV/MC/tW_DR_v7/edmntuple_1_1_FyJ.root',
                             #'edmntuple.root',
                             )),
...
#Output
process.TFileService = cms.Service("TFileService", fileName = cms.string("output/ntuple_SysTrees_TEST.root"))
...
process.TreesDileptontW.channelInfo = TTBar
