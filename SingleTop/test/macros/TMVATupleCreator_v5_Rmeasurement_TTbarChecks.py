...
treeList = {'tree1j1t_BfromT'   :[TTree('1j1t_T','1j1t_T'),TTree('1j1t_T','1j1t_T'),TTree('1j1t_T','1j1t_T')],
            'tree1j1t_BfromTbar':[TTree('1j1t_Tbar','1j1t_Tbar'),TTree('1j1t_Tbar','1j1t_Tbar'),TTree('1j1t_Tbar','1j1t_Tbar')],
            }
...
#         passMET = True
    ...
    jetHasTParent = event.jetHasTParent
...
#                         btaggedLooseJet25Idx.append(i)
    ...
    if jetHasTParent[jetIdx] < -10 or jetHasTParent[jetIdx] == 0:
        continue

    BisFromTop = False
    BisFromAntiTop = False
    if jetHasTParent[jetIdx] == 1:
        BisFromTop = True
    if jetHasTParent[jetIdx] == -1:
        BisFromAntiTop = True
...
#    eventInfo.weightBtagSF = btagSF_
    ...
    if not inZpeak and passMET:
        if len(goodJetIdx) == 1:
            ...
            if 'tree1j1t_BfromTbar' in treeList:
                if len(btaggedTightJetIdx) == 1:
                    if BisFromTop:
                        treeList['tree1j1t_BfromT'][ModeIdx].Fill()
                    if BisFromAntiTop:
                        treeList['tree1j1t_BfromTbar'][ModeIdx].Fill()
        if len(goodJetIdx) == 2:
...
outFileName = 'tmvaFiles/'+fileVersion+'/TestofTTbarSplit.root'
