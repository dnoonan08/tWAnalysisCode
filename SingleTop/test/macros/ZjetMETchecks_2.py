...
#     vFolder = 'v3_Rmeasurement-2_newZjetPeak'
    vFolder = 'ZpeakRegion'
...
#    leg.SetFillStyle(1)
    ...
    leg.AddEntry(HistoLists[6]['met'], "Diboson", "f")
    ...
    for plot in plotInfo:
        ...
        HistoLists[6][plot[0]].Add(HistoLists[7][plot[0]])
        HistoLists[6][plot[0]].Add(HistoLists[8][plot[0]])
        
        hStack = THStack(plot[0],plot[0])
        hStack.Add(HistoLists[2][plot[0]])
        hStack.Add(HistoLists[6][plot[0]])
    ...
    other = HistoLists[0]['metBinned'].Clone("other")    
    data = HistoLists[-1]['metBinned']
    other.Add(HistoLists[1]['metBinned'])
    other.Add(HistoLists[2]['metBinned'])
    other.Add(HistoLists[5]['metBinned'])
    other.Add(HistoLists[6]['metBinned'])
    ...
    print
    print "Bin Content"
    print "Bin range\t  Zjets \t ttbar \t tW \t Diboson \t Other \t Data"
    for bin in range(1,len(bins)):
        print bins[bin-1],"-",bins[bin],"\t:","%.1f" % zjet.GetBinContent(bin),\
              "\t","%.1f" % HistoLists[1]['metBinned'].GetBinContent(bin),\
              "\t","%.1f" % HistoLists[0]['metBinned'].GetBinContent(bin),\
              "\t","%.1f" % HistoLists[6]['metBinned'].GetBinContent(bin),\
              "\t","%.1f" % HistoLists[2]['metBinned'].GetBinContent(bin),\
              "\t","%.1f" % data.GetBinContent(bin)
    print
    print "-------------------------------------------------------------------"
    print "Scale Factor"
