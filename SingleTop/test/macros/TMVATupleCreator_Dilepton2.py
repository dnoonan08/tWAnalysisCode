...
#Only makes 2j0t, 3+jNotagging, and 3+jets1+tags 
...
treeList = { 'tree1j1tLooseJets':[TTree('1j1tLooseJets','1j1tLooseJets'),TTree('1j1tLooseJets','1j1tLooseJets'),TTree('1j1tLooseJets','1j1tLooseJets')],
             'tree1j1tNoLooseJets':[TTree('1j1tNoLooseJets','1j1tNoLooseJets'),TTree('1j1tNoLooseJets','1j1tNoLooseJets'),TTree('1j1tNoLooseJets','1j1tNoLooseJets')],
             'tree1j1tCentralLooseJets':[TTree('1j1tCentralLooseJets','1j1tCentralLooseJets'),TTree('1j1tCentralLooseJets','1j1tCentralLooseJets'),TTree('1j1tCentralLooseJets','1j1tCentralLooseJets')],
             'tree1j1tNoCentralLooseJets':[TTree('1j1tNoCentralLooseJets','1j1tNoCentralLooseJets'),TTree('1j1tNoCentralLooseJets','1j1tNoCentralLooseJets'),TTree('1j1tNoCentralLooseJets','1j1tNoCentralLooseJets')],
             'tree1j1tBtaggedLooseJets':[TTree('1j1tBtaggedLooseJets','1j1tBtaggedLooseJets'),TTree('1j1tBtaggedLooseJets','1j1tBtaggedLooseJets'),TTree('1j1tBtaggedLooseJets','1j1tBtaggedLooseJets')],
             'tree1j1tNoBtaggedLooseJets':[TTree('1j1tNoBtaggedLooseJets','1j1tNoBtaggedLooseJets'),TTree('1j1tNoBtaggedLooseJets','1j1tNoBtaggedLooseJets'),TTree('1j1tNoBtaggedLooseJets','1j1tNoBtaggedLooseJets')],
            }
...
#    eventInfo.weightBtagSF = btagSF_
    ...
    nLooseJets = len(looseJet20Idx)
    nLooseJetsCentral = len(looseJet20CentralIdx)
    nBtaggedLooseJets = len(btaggedLooseJet20Idx)
    ...
    eventInfo.mll = (lepton0+lepton1).M()
    ...
    if not inZpeak and passMET:
        if len(goodJetIdx) == 1:
            if len(btaggedTightJetIdx) == 1:
                if nLooseJets == 0:
                    treeList['tree1j1tNoLooseJets'][ModeIdx].Fill()
                else:
                    treeList['tree1j1tLooseJets'][ModeIdx].Fill()

                if nLooseJetsCentral == 0:
                    treeList['tree1j1tNoCentralLooseJets'][ModeIdx].Fill()
                else:
                    treeList['tree1j1tCentralLooseJets'][ModeIdx].Fill()

                if nBtaggedLooseJets == 0:
                    treeList['tree1j1tNoBtaggedLooseJets'][ModeIdx].Fill()
                else:
                    treeList['tree1j1tBtaggedLooseJets'][ModeIdx].Fill()
