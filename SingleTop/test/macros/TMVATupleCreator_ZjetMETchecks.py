...
treeList = {'tree1j0tNoMETmllCut':[TTree('1j0tNoMETmllCut','1j0tNoMETmllCut'),TTree('1j0tNoMETmllCut','1j0tNoMETmllCut'),TTree('1j0tNoMETmllCut','1j0tNoMETmllCut')],
            'tree1j1tNoMETmllCut':[TTree('1j1tNoMETmllCut','1j1tNoMETmllCut'),TTree('1j1tNoMETmllCut','1j1tNoMETmllCut'),TTree('1j1tNoMETmllCut','1j1tNoMETmllCut')],
            'treeZpeakLepSel':[TTree('ZpeakLepSel','ZpeakLepSel'),TTree('ZpeakLepSel','ZpeakLepSel'),TTree('ZpeakLepSel','ZpeakLepSel')],
            }
...
#    eventInfo.weightBtagSF = btagSF_
    ...
    if len(goodJetIdx) == 1:
           if len(btaggedTightJetIdx) == 0:
               treeList['tree1j0tNoMETmllCut'][ModeIdx].Fill()
           if len(btaggedTightJetIdx) == 1:
               treeList['tree1j1tNoMETmllCut'][ModeIdx].Fill()
    if inZpeak:
