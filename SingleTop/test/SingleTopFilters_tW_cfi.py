...
HLTFiltertH = cms.EDFilter('SingleTopTriggers',
                           HLTriggerResults = cms.InputTag("TriggerResults","",processNameData),
                           isMC = cms.untracked.bool(False),
                           triggerList = cms.vstring("HLT_IsoMu17_eta2p1_TriCentralPFNoPUJet50_40_30_v",
                                                     ),
                           runRangesList = cms.vint32(-1),
...
HLTFilterTWDoubleMu2012 = cms.EDFilter('SingleTopTriggers',
                                       HLTriggerResults = cms.InputTag("TriggerResults","",processNameData),
                                       isMC = cms.untracked.bool(False),
                                       triggerList = cms.vstring("HLT_Mu17_Mu8_v",
                                                                 "HLT_Mu17_TkMu8_v",
                                                                 ),
                                       runRangesList = cms.vint32(-1),
...
HLTFilterTWDoubleEle2012 = cms.EDFilter('SingleTopTriggers',
                                       HLTriggerResults = cms.InputTag("TriggerResults","",processNameData),
                                       isMC = cms.untracked.bool(False),
                                       triggerList = cms.vstring("HLT_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v",
                                                                 ),
                                       runRangesList = cms.vint32(-1),
...
HLTFilterTWEleMu2012 = cms.EDFilter('SingleTopTriggers',
                                       HLTriggerResults = cms.InputTag("TriggerResults","",processNameData),
                                       isMC = cms.untracked.bool(False),
                                       triggerList = cms.vstring("HLT_Mu17_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v",
...
HLTFilterTWDilepton2012 = cms.EDFilter('SingleTopTriggers',
                                       HLTriggerResults = cms.InputTag("TriggerResults","",processNameData),
                                       isMC = cms.untracked.bool(False),
                                       triggerList = cms.vstring("HLT_Mu17_Ele8_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v",
                                                                 "HLT_Mu8_Ele17_CaloIdT_CaloIsoVL_TrkIdVL_TrkIsoVL_v",
