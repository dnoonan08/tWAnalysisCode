...
process.pfPileUp.checkClosestZVertex = False  #Added in order to match Rebeca's PF2PAT settings
                                              #Added in order to match Rebeca's PF2PAT settings
process.pfNoPileUp.enable = True              #Added in order to match Rebeca's PF2PAT settings
process.pfNoMuon.enable = True                #Added in order to match Rebeca's PF2PAT settings
process.pfNoElectron.enable = True            #Added in order to match Rebeca's PF2PAT settings
process.pfNoTau.enable = False                #Added in order to match Rebeca's PF2PAT settings
process.pfNoJet.enable = False                #Added in order to match Rebeca's PF2PAT settings
...
print " test 0 " 
#process.pfIsolatedMuons.combinedIsolationCut = cms.double(999.)
#process.pfIsolatedElectrons.combinedIsolationCut = cms.double(999.)
