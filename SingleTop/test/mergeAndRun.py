...
okChannelNames = ['TChannel',
                  ...
                  'TWChannel_Q2UpSemiLep1',
                  'TWChannel_Q2DownSemiLep1',
                  'TbarWChannel_Q2UpSemiLep1',
                  'TbarWChannel_Q2DownSemiLep1',
                  'TWChannel_Q2UpSemiLep2',
                  'TWChannel_Q2DownSemiLep2',
                  'TbarWChannel_Q2UpSemiLep2',
                  'TbarWChannel_Q2DownSemiLep2',
                  'TWChannelSemilepton1',
                  'TWChannelSemilepton2',
                  'TbarWChannelSemilepton1',
                  'TbarWChannelSemilepton2',
                  'TWChannelDilepton_5',
                  'TbarWChannelDilepton_5',
                  ]
