...
nTupleTopJetsPF = cms.EDProducer(
    ...
    cms.PSet(
    tag = cms.untracked.string("ptLeadingTrack"),
    quantity = cms.untracked.string("userFloat(\"ptLeadingTrack\")")
    ),
    cms.PSet(
    tag = cms.untracked.string("ptRaw"),
    quantity = cms.untracked.string("userFloat(\"ptRaw\")")
    ),
    cms.PSet(
    tag = cms.untracked.string("isSemiLept"),
    quantity = cms.untracked.string("userFloat(\"isSemiLept\")")
    ),
    cms.PSet(
    tag = cms.untracked.string("SoftLeptonPt"),
    quantity = cms.untracked.string("userFloat(\"SoftLeptPt\")")
    ),
    cms.PSet(
    tag = cms.untracked.string("SoftLeptonPtRel"),
    quantity = cms.untracked.string("userFloat(\"SoftLeptPtRel\")")
    ),
    cms.PSet(
    tag = cms.untracked.string("SoftLeptondR"),
    quantity = cms.untracked.string("userFloat(\"SoftLeptdR\")")
    ),
    cms.PSet(
    tag = cms.untracked.string("SoftLeptonpdgId"),
    quantity = cms.untracked.string("userFloat(\"SoftLeptpdgId\")")
    ),
    cms.PSet(
    tag = cms.untracked.string("SoftLeptonIdlooseMu"),
    quantity = cms.untracked.string("userFloat(\"SoftLeptIdlooseMu\")")
    ),
    cms.PSet(
    tag = cms.untracked.string("SoftLeptonId95"),
    quantity = cms.untracked.string("userFloat(\"SoftLeptId95\")")
    ),
    cms.PSet(
    tag = cms.untracked.string("Mt"),
    quantity = cms.untracked.string("mt")
    ),
    cms.PSet(
    tag = cms.untracked.string("vtxPt"),
    quantity = cms.untracked.string("userFloat(\"vtxPt\")")
    ),
    cms.PSet(
    ...
    cms.PSet(
    tag = cms.untracked.string("vtxNTracks"),
    quantity = cms.untracked.string("userFloat(\"vtxNTracks\")")
    ),
    cms.PSet(
    tag = cms.untracked.string("vtx3dL"),
    quantity = cms.untracked.string("userFloat(\"vtx3dL\")")
    ),
    cms.PSet(
    tag = cms.untracked.string("vtx3deL"),
    quantity = cms.untracked.string("userFloat(\"vtx3deL\")")
    ),
    cms.PSet(
    tag = cms.untracked.string("nch"),
    quantity = cms.untracked.string("associatedTracks().size")
    ),
    cms.PSet(
    tag = cms.untracked.string("nconst"),
    quantity = cms.untracked.string("getPFConstituents().size")
    ),
    cms.PSet(
    tag = cms.untracked.string("genPDGId"),
    quantity = cms.untracked.string("userFloat(\"genPDGId\")")
    ),
    cms.PSet(
    tag = cms.untracked.string("motherPDGId"),
    quantity = cms.untracked.string("userFloat(\"motherPDGId\")")
    ),
    cms.PSet(
    tag = cms.untracked.string("grandmotherPDGId"),
    quantity = cms.untracked.string("userFloat(\"grandmotherPDGId\")")
    ),

    cms.PSet(
    tag = cms.untracked.string("hasBparent"),
    quantity = cms.untracked.string("userInt(\"hasBparent\")")
    ),
    cms.PSet(
    tag = cms.untracked.string("hasTparent"),
    quantity = cms.untracked.string("userInt(\"hasTparent\")")
    ),
    cms.PSet(
    tag = cms.untracked.string("hasZparent"),
    quantity = cms.untracked.string("userInt(\"hasZparent\")")
    ),
    cms.PSet(
    tag = cms.untracked.string("hasWparent"),
    quantity = cms.untracked.string("userInt(\"hasWparent\")")
    ),
    cms.PSet(
    tag = cms.untracked.string("hasHparent"),
    quantity = cms.untracked.string("userInt(\"hasHparent\")")
    ),
...
#    quantity = cms.untracked.string('(chargedHadronIso+ max(0., neutralHadronIso + photonIso -0.5*puChargedHadronIso()))/pt'),
    ...
    #NEW FOR TH ANALYSIS
#     cms .PSet(
#     tag = cms.untracked.string("normChi2"),
#     quantity = cms.untracked.string("normChi2")
#     ),
#     cms .PSet(
#     tag = cms.untracked.string("numberofMatchedStations"),
#     quantity = cms.untracked.string("numberOfMatchedStations")
#     ),
#     cms .PSet(
#     tag = cms.untracked.string("TrackerValidPixelHits"),
#     quantity = cms.untracked.string("innerTrack().hitPattern.numberOfValidPixelHits")
#     ),
#     cms .PSet(
#     tag = cms.untracked.string("TrackerLayersWithMeasurement"),
#     quantity = cms.untracked.string("innerTrack().hitPattern.trackerLayersWithMeasurement")
#     ),
#     cms .PSet(
#     tag = cms.untracked.string("TrackerValidMuonHits"),
#     quantity = cms.untracked.string("globalTrack().hitPattern.numberOfValidMuonHits")
#     ),
    cms.PSet(
