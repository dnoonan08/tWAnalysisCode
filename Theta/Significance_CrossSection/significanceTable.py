...
# print '  \hline'
# print '  $e\mu/\mu\mu/ee$ & $',observedList[0],'$ & $',expectedList[0],'^{',expectedListUp[0],'}_{',expectedListDown[0],'} $ & $',crossSecList[0],'^{',crossSecListUp[0],'}_{',crossSecListDown[0],'}$\\\\'
# print '  \hline'
# print '  $e\mu$ & $',observedList[1],'$ & $',expectedList[1],'^{',expectedListUp[1],'}_{',expectedListDown[1],'} $ & $',crossSecList[1],'^{',crossSecListUp[1],'}_{',crossSecListDown[1],'}$\\\\'
# print '  $\mu\mu$ & $',observedList[2],'$ & $',expectedList[2],'^{',expectedListUp[2],'}_{',expectedListDown[2],'} $ & $',crossSecList[2],'^{',crossSecListUp[2],'}_{',crossSecListDown[2],'}$\\\\'
# print '  $ee$ & $',observedList[3],'$ & $',expectedList[3],'^{',expectedListUp[3],'}_{',expectedListDown[3],'} $ & $',crossSecList[3],'^{',crossSecListUp[3],'}_{',crossSecListDown[3],'}$\\\\'
# print '  \hline'
# print '  $e\mu/\mu\mu$ & $',observedList[4],'$ & $',expectedList[4],'^{',expectedListUp[4],'}_{',expectedListDown[4],'} $ & $',crossSecList[4],'^{',crossSecListUp[4],'}_{',crossSecListDown[4],'}$\\\\'
# print '  $e\mu/ee$ & $',observedList[5],'$ & $',expectedList[5],'^{',expectedListUp[5],'}_{',expectedListDown[5],'} $ & $',crossSecList[5],'^{',crossSecListUp[5],'}_{',crossSecListDown[5],'}$\\\\'
# print '  $ee/\mu\mu$ & $',observedList[6],'$ & $',expectedList[6],'^{',expectedListUp[6],'}_{',expectedListDown[6],'} $ & $',crossSecList[6],'^{',crossSecListUp[6],'}_{',crossSecListDown[6],'}$\\\\'
# print '  \hline'
# print '  \end{tabular}'
# print '\end{center}'
# print '\end{table*}'
